...
> **Совет:** все значения можно подобрать под свои задачи — уменьшать или увеличивать глубину и лимиты, менять задержки между переходами, настраивать, какие типы файлов и разделы сайта пропускать.
...
const SERVER_ENDPOINT = '/remove-unused-css/remove-unused-css.php'

// ID элементов управления в DOM
const BUTTON_ID = 'unused-css-button'
const MENU_ID   = 'unused-css-menu'
const SETTINGS_ID = 'unused-css-settings'
```
